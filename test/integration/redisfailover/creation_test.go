...
import (
	...
	redisfailoverclientset "github.com/jesstracy/redis-operator/client/k8s/clientset/versioned"
	"github.com/jesstracy/redis-operator/cmd/utils"
	"github.com/jesstracy/redis-operator/log"
	"github.com/jesstracy/redis-operator/metrics"
	"github.com/jesstracy/redis-operator/operator/redisfailover"
	"github.com/jesstracy/redis-operator/service/k8s"
	"github.com/jesstracy/redis-operator/service/redis"
)
